...
class ImageValidationService {
    ...
    static async classifyAndUnderstandImage(params) {
        ...
        if (!apiKey || apiKey.trim() === '') {
            throw new Error('AI Vision service is not configured. Please configure the required AI API key (GEMINI_API_KEY in server/.env).');
        }
  ...
  "qualityScore": number
    ...
    static async validateCropLeafImage(params) {
        ...
        return {
            ...
            validationStatus: understanding.validationStatus === 'VALID_LEAF'
                ? 'VALID'
