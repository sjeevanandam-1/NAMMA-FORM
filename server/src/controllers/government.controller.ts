  ...
  static async getAnalytics(req: Request, res: Response): Promise<void> {
    try {
      ...
      const [
        ...
        prisma.farmerProfile.count({ where: state ? { state } : {} }),
      ...
      const aiInsights = [
        {
          ...
          summary:
            'District wholesale arrivals are 18% below seasonal averages due to unseasonal rainfall. Farmgate prices projected to surge +14% over the next two weeks.',
          impactLevel: 'HIGH',
          dataPeriod: 'Last 30 Days (Aug 2026)',
          dataSource: 'APMC Mandi Arrival Records & Namma Farm Order Stream',
          isAIGenerated: true,
          recommendedAction:
            'Initiate inter-district buffer stock allocation from Hosur production belts to stabilize urban retail prices.',
        },
        {
          id: 'INS-02',
          ...
          summary:
            'Whitefly pest incidence reported in 22 cluster farms. Immediate IPM advisory distribution recommended before flowering peak.',
          impactLevel: 'MEDIUM',
          dataPeriod: 'Active Surveillance (Aug 2026)',
          dataSource: 'Namma Farm AI Crop Doctor Scans & State Horticulture Dept',
          isAIGenerated: true,
          recommendedAction:
            'Broadcast organic neem oil and yellow sticky trap subsidies via KVK mobile portals.',
        },
        {
          id: 'INS-03',
          ...
          summary:
            'Adequate seasonal supply detected. Farmer net realizations are holding stable at ₹32/kg with healthy buyer procurement demand.',
          impactLevel: 'LOW',
